...
def main(cfg):
    ...
    dataset_path = cfg.get("dataset_path", "~/datasets")
    cuda = torch.cuda.is_available()
    DEVICE = torch.device("cuda" if cuda else "cpu")
    batch_size = cfg.hyperparams.batch_size
    x_dim = cfg.hyperparams.x_dim
    hidden_dim = cfg.hyperparams.hidden_dim
    latent_dim = cfg.hyperparams.latent_dim
    # ensure seed is an int even if YAML parsed it as a string
    seed = int(cfg.hyperparams.seed) if isinstance(cfg.hyperparams.seed, str) else cfg.hyperparams.seed
